		...
		do {
			...
			while (!acertou) {
				...
				case "acertou":
					...
					break;
				case "maior":
					System.out.println("Dica: A bosta do número é MAIOR que " + tentativa); // Dica quando o palpite é
																							// menor.
					break;
				case "menor":
					System.out.println("Dica: A porcaria do número é MENOR que " + tentativa); // Dica quando o palpite
																								// é maior.
					break;
				}
			}
